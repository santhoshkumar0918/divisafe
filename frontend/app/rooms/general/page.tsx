...
import { Send, MessageCircle, ArrowLeft, Users, Shield, User, Crown } from 'lucide-react'
import { motion } from 'framer-motion'

// Updated interface to match the provided structure
interface Message {
  id: string
  content: string
  sender: string
...
const sampleMessages: Message[] = [
  { id: '1', content: "Welcome to the General Support room. This is a safe space to discuss any divorce-related topics. Remember, we're all here to support each other.", sender: 'Moderator Sarah', timestamp: new Date(Date.now() - 300000), isModerator: true },
  { id: '2', content: "I'm going through a difficult time and could use some support from others who understand. The paperwork alone is overwhelming.", sender: 'Anonymous', timestamp: new Date(Date.now() - 180000) },
  { id: '3', content: "You're not alone in feeling overwhelmed. Many of us here have been through similar experiences. Take it one step at a time. What specific part is causing you the most stress?", sender: 'Anonymous', timestamp: new Date(Date.now() - 120000) },
  { id: '4', content: "The financial aspects are really scary. I don't know how I'll manage on my own.", sender: 'Anonymous', timestamp: new Date(Date.now() - 60000) },
]
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-bold text-white">General Support</h1>
                  <p className="text-gray-400 text-xs">Open discussion and peer support</p>
                </div>
              </div>
            </div>
